...
export default function SigninScreen() {
  const { signIn, setAuthToTrue } = useAuth();
  ...
  const onSubmit = async ({ email, password }: AuthCredentials) => {
    ...
    try {
      ...
      if (error.name === 'NotAuthorizedException') {
        ...
        console.log('signin.tsx onSubmit error:', error);
      }
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Links */}
      <Link href="/resetPassword" dismissTo asChild>
        <TouchableOpacity style={styles.link}>
          <Text style={styles.linkText}>¿Olvidaste tu contraseña?</Text>
        </TouchableOpacity>
      </Link>
      <Link href="/signup" dismissTo asChild>
        <TouchableOpacity style={styles.link}>
